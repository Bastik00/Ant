...
public class View3D extends DisplayPanel implements GLEventListener,
		ActionListener, FiguresListener {
	private static final long serialVersionUID = 1L;
	private GLJPanel panel = new GLJPanel();
	private static GLU glu = new GLU();
	private FPSAnimator animator = new FPSAnimator(30);
	...
	public View3D(FPSAnimator animator, FiguresEventHandler eventHandler) {
	...
	/**
	 * set figures to the View
	 */
	public void setFigures() {
		if (figures.getSize() == 0) {
			System.out.println("No figures have been loaded yet");
		}
	...
	private JMenuItem addMenuItem(JPopupMenu popupMenu, String text,
			String command) {
	...
	public void actionPerformed(ActionEvent arg0) {
		this.getTopLevelAncestor().add(new CameraControl(this.camera));
	}
