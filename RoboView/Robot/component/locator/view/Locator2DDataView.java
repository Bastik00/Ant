...
public class Locator2DDataView extends ComponentView implements LocatorChangeNotifier{
...
public Locator2DDataView(Locator2D sensor) 
{
...
protected void makePopupMenu()
{
	...
	this.contextMenue.add(new JSeparator());
	 ...
	 this.showMilimmeterItem = this.addRadioButtonMenuItem(this.contextMenue , Locator2DDataView.MILIMETER_TEXT, "");
	 this.showMilimmeterItem.setSelected(false);

	 this.showCentimeterItem = this.addRadioButtonMenuItem(this.contextMenue , Locator2DDataView.CENTIMETER_TEXT, "");

	 this.showMeterItem = this.addRadioButtonMenuItem(this.contextMenue , Locator2DDataView.METER_TEXT, "");
...
{
	return(Locator2DDataView.width);
}

@Override
protected int getViewHeight()
{
	return(Locator2DDataView.height);
}
 ...
 */
public static ComponentView createView(Locator2D sensor)
{
	 
	if (sensor!=null)
	{
		return(new Locator2DDataView(sensor));
	}
	else
	{
