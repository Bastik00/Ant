package de.hska.lat.robot.component.actor.motor.pwmMotor.view;
...
public class PwmMotorControlView extends ComponentView implements
		ChangeListener, ComponentSettingsChangeNotifier
{
	...
	public PwmMotorControlView(RpmMotor motor)
	{
	...
	protected void buildView()
	{
		...
		JButton tmpButton;
		tmpButton = new JButton(PwmMotorControlView.STOP_TXT);
		...
		tmpButton.addActionListener(new ActionListener()
		{
			...
			{
				PwmMotorControlView.this.motor.remote_stop();
		...
		tmpButton = new JButton(PwmMotorControlView.BRAKE_TXT);
		...
		tmpButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				PwmMotorControlView.this.motor.remote_brake();
			}
	...
	{
		return (PwmMotorControlView.width);
	}

	@Override
	protected int getViewHeight()
	{
		return (PwmMotorControlView.height);
	}
	...
	public static ComponentView createView(RpmMotor motor)
	{
		if (motor != null)
		{
			return (new PwmMotorControlView(motor));
		} else
		{
