...
public class Tmp102Protocol extends TemperatureSensorProtocol
{

	public Tmp102Protocol(int deviceId,
 ...
 * @return
 */
public ArrayList<RemoteCommandProcessor> getCommandProcessors(Tmp102Set sensorSet)	
{
...
public ArrayList<RemoteMessageProcessor> getMessageProcessors(Tmp102Set sensorSet)
{
