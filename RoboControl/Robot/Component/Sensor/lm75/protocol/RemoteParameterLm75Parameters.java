...
public class RemoteParameterLm75Parameters extends RemoteParameter<RemoteParameterLm75Parameters>
{
	...
	public RemoteParameterLm75Parameters()
	{
	...
	{
		return(RemoteParameterLm75Parameters.BYTE_SIZE);
	}
	...
	public String getAsString(boolean description)
	{
		...
		if (description)
		{
			returnString+= RemoteParameterLm75Parameters.name+" ";
