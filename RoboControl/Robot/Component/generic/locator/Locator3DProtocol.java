...
import de.hska.lat.robot.component.generic.locator.protocol.Msg_location3D;
...
public class Locator3DProtocol extends SensorProtocol
{

	public final int cmdSetLocationId;
	
	
	public Locator3DProtocol(int deviceId, 
...
public ArrayList<RemoteMessageProcessor> getMessageProcessors(RemoteDecoder decoder)
{
	...
	messages.add(new RemoteMessageProcessor(
			new Msg_location3D(this.msgValueId), 
			decoder));
