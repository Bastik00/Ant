...
public class Cmd_setHeading3D extends RemoteCommand
{
...
public Cmd_setHeading3D(int command) 
{
	this();
	this.setId(command);
}
...
{
	return(Cmd_setHeading3D.description);
}
...
public int getIndex()
{
	return((( RemoteParameterUint8) this.get(Cmd_setHeading3D.INDEX_SENSOR)).getValue());
}

public int getRange()
{
	return((( RemoteParameterUint8) this.get(Cmd_setHeading3D.INDEX_RANGE)).getValue());
}


public int getGain()
{
	return((( RemoteParameterUint8) this.get(Cmd_setHeading3D.INDEX_GAIN)).getValue());
}


public int getAddress()
{
	return((( RemoteParameterUint8) this.get(Cmd_setHeading3D.INDEX_ADDRESS)).getValue());
}



public static Cmd_setHeading3D getCommand(int id)
{
	Cmd_setHeading3D cmd;
	cmd = new Cmd_setHeading3D(id);
...
public static Cmd_setHeading3D getCommand(int command, float heading)
{
	
	Cmd_setHeading3D cmd;
	cmd = Cmd_setHeading3D.getCommand(command);
	cmd.setData(heading);
